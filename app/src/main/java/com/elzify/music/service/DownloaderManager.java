...
import com.elzify.music.repository.DownloadRepository;
...
public class DownloaderManager {
    ...
    public void download(MediaItem mediaItem, com.elzify.music.model.Download download) {
    ...
    public void download(List<MediaItem> mediaItems, List<com.elzify.music.model.Download> downloads) {
        for (int counter = 0; counter < mediaItems.size(); counter++) {
            download(mediaItems.get(counter), downloads.get(counter));
        }
    }

    public void remove(MediaItem mediaItem, com.elzify.music.model.Download download) {
    ...
    public void remove(List<MediaItem> mediaItems, List<com.elzify.music.model.Download> downloads) {
        for (int counter = 0; counter < mediaItems.size(); counter++) {
    ...
    public static String getDownloadNotificationMessage(String id) {
        com.elzify.music.model.Download download = getDownloadRepository().getDownload(id);
    ...
    private static void insertDatabase(com.elzify.music.model.Download download) {

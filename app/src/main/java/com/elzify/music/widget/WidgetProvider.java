package com.elzify.music.widget;
...
public class WidgetProvider extends AppWidgetProvider {
    ...
    public static final String ACT_PLAY_PAUSE = "music.widget.PLAY_PAUSE";
    public static final String ACT_NEXT = "music.widget.NEXT";
    public static final String ACT_PREV = "music.widget.PREV";
    public static final String ACT_TOGGLE_SHUFFLE = "music.widget.SHUFFLE";
    public static final String ACT_CYCLE_REPEAT = "music.widget.REPEAT";

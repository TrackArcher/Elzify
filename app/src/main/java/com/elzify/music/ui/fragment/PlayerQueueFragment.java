...
import com.elzify.music.databinding.InnerFragmentPlayerQueueBinding;
...
import com.elzify.music.ui.adapter.PlayerSongQueueAdapter;
...
public class PlayerQueueFragment extends Fragment implements ClickCallback {
    ...
    private void handleDownloadAllClick() {
        ...
        if (Preferences.getDownloadDirectoryUri() == null) {
            ...
            List<com.elzify.music.model.Download> downloadModels = new ArrayList<>();

            for (Child child : queueSongs) {
                com.elzify.music.model.Download downloadModel =
                        new com.elzify.music.model.Download(child);

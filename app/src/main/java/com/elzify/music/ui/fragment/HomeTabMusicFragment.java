...
import com.elzify.music.databinding.FragmentHomeTabMusicBinding;
import com.elzify.music.helper.recyclerview.CustomLinearSnapHelper;
import com.elzify.music.helper.recyclerview.DotsIndicatorDecoration;
import com.elzify.music.interfaces.ClickCallback;
import com.elzify.music.interfaces.PlaylistCallback;
...
import com.elzify.music.ui.adapter.AlbumAdapter;
import com.elzify.music.ui.adapter.AlbumCarouselAdapter;
import com.elzify.music.ui.adapter.AlbumHorizontalAdapter;
import com.elzify.music.ui.adapter.ArtistAdapter;
import com.elzify.music.ui.adapter.ArtistHorizontalAdapter;
import com.elzify.music.ui.adapter.DiscoverSongAdapter;
import com.elzify.music.ui.adapter.PlaylistHorizontalAdapter;
import com.elzify.music.ui.adapter.ShareHorizontalAdapter;
import com.elzify.music.ui.adapter.SimilarTrackAdapter;
import com.elzify.music.ui.adapter.SongHorizontalAdapter;
import com.elzify.music.ui.adapter.YearAdapter;
import com.elzify.music.ui.dialog.HomeRearrangementDialog;
    ...
    private void initPinnedPlaylistsView() {
        ...
        homeViewModel.getPinnedPlaylists(getViewLifecycleOwner()).observe(getViewLifecycleOwner(), playlists -> {
            if (playlists == null) {
                ...
                java.util.List<String> ids = playlists.stream().map(com.elzify.music.subsonic.models.Playlist::getId).collect(java.util.stream.Collectors.toList());

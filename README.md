...
Elzify is a modern Android Subsonic-compatible music client focused on fast browsing, reliable playback, and power-user features without unnecessary clutter.
...
Elzify is released under the [GNU General Public License v3.0](LICENSE).

## Credits

Elzify builds on work from the Subsonic Android client ecosystem and its open-source contributors.

Special thanks to:
- **Songseeker**
- **Subsonicster**
- **Tempus**
- **Rollyn (fork of Tempus)**
